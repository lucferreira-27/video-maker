...
//	private final String folderDestImg = System.getProperty("user.dir") + "\\resourses\\images\\";
//	private final String folderDestVideo = System.getProperty("user.dir") + "\\resourses\\video-resouces\\";
	...
	public String loadImageMagick() throws Exception {
		...
		return null;
		// findFolders.forEach(l -> imageMagickVersions.add( l.substring(l.indexOf("-")
		// + 1, l.indexOf("portable") - 1)));
		// System.out.println(imageMagickVersions);
	}
